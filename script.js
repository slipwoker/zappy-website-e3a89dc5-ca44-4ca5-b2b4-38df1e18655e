    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בן אלון עיצוב תאורה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e3a89dc5-ca44-4ca5-b2b4-38df1e18655e',
                    name: data.name || '',
                    email: data.email || '',
